...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var tweetsRef, tweetId;
            return __generator(this, function (_a) {
                tweetsRef = (0, database_1.ref)(database, '/tweets');
                tweetId = interaction.options.getString('id');
                (0, database_1.onValue)(tweetsRef, function (snapshot) {
